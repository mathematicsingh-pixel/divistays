...
import { availableRooms, findRoomBySlug, getSimilarRooms } from '@/data/rooms'
import { buildImagePath } from '@/lib/media'
import { buildRoomStructuredData } from '@/lib/schema'
