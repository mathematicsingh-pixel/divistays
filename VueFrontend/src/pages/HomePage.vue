...
import AvailableRoomsSection from '@/components/sections/AvailableRoomsSection.vue'
import ApproximateLocationSection from '@/components/sections/ApproximateLocationSection.vue'
...
import { buildHomeStructuredData } from '@/lib/schema'
